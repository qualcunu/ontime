...
export const setMessage = {
  ...
  aux1Label: (payload: string) => sendSocket('message', { aux1label: payload }),
  aux2Label: (payload: string) => sendSocket('message', { aux2label: payload }),
  aux3Label: (payload: string) => sendSocket('message', { aux3label: payload }),
